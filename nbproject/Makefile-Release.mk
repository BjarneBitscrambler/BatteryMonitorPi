...
${OBJECTDIR}/N2kDeviceList.o: N2kDeviceList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/N2kDeviceList.o N2kDeviceList.cpp

${OBJECTDIR}/N2kGroupFunction.o: N2kGroupFunction.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/N2kGroupFunction.o N2kGroupFunction.cpp

${OBJECTDIR}/N2kGroupFunctionDefaultHandlers.o: N2kGroupFunctionDefaultHandlers.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/N2kGroupFunctionDefaultHandlers.o N2kGroupFunctionDefaultHandlers.cpp

${OBJECTDIR}/N2kMessages.o: N2kMessages.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/N2kMessages.o N2kMessages.cpp

${OBJECTDIR}/N2kMsg.o: N2kMsg.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/N2kMsg.o N2kMsg.cpp

${OBJECTDIR}/N2kStream.o: N2kStream.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/N2kStream.o N2kStream.cpp

${OBJECTDIR}/NMEA2000.o: NMEA2000.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NMEA2000.o NMEA2000.cpp

${OBJECTDIR}/NMEA2000_SocketCAN.o: NMEA2000_SocketCAN.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NMEA2000_SocketCAN.o NMEA2000_SocketCAN.cpp

${OBJECTDIR}/TrilliumBatteryInterface.o: TrilliumBatteryInterface.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TrilliumBatteryInterface.o TrilliumBatteryInterface.cpp
